  ...
  if (loading) {
    return (
      <div className="flex flex-col min-h-screen items-center justify-center bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
        <p className="text-lg">Loading special offer...</p>
      </div>
    );
  }
    ...
    return (
      <div className="flex flex-col min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
        <main className="flex-grow flex items-center justify-center">
          <p className="text-lg">Special offer not found.</p>
        </main>
        <Footer />
      </div>
    );
      ...
      <main className="flex-grow p-6 max-w-7xl mx-auto w-full">
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="md:w-1/2 relative rounded-xl overflow-hidden shadow-lg">
            <img
              src={offer.imageUrl}
              alt={offer.propertyName || "Special Offer"}
          ...
          <div className="md:w-1/2 flex flex-col justify-start">
            <h1 className="text-3xl font-bold mb-2">{offer.propertyName}</h1>
            ...
            <div className="text-xl font-semibold mb-4">
              {offer.price ? `${offer.price} Br` : "Price not available"}
            </div>
